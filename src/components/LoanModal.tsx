...
export const LoanModal: React.FC<LoanModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-lg my-8 rounded-3xl bg-[#111422] border border-amber-500/30 p-6 sm:p-8 shadow-2xl overflow-hidden text-white">
        ...
        {isFreePlan ? (
          ...
          <div className="mt-6 text-center py-6 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-gray-300 max-w-sm mx-auto leading-relaxed">
              9jaLoan is an exclusive financial privilege reserved for verified <strong>VIP Premium Members</strong>. Upgrade your account to borrow up to <strong>₦50,000</strong> with instant wallet disbursement.
            </p>

            <div className="p-4 rounded-2xl bg-gray-900/80 border border-gray-800 text-left text-xs space-y-2 text-gray-400">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 text-black font-extrabold text-sm shadow-xl shadow-amber-950/50 hover:scale-105 transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="mt-6 space-y-5">
            <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-200 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider">Active Loan Status</span>
                <span className="text-xs px-2 py-0.5 rounded bg-amber-500/20 font-mono font-bold">ACTIVE</span>
              </div>
            ...
            <div className="p-4 rounded-2xl bg-black/40 border border-gray-800 space-y-2 text-xs">
              ...
              <div className="flex justify-between text-gray-400">
                ...
                <span className="text-amber-400 font-bold">₦{user.loanBalance.toLocaleString()}</span>
              </div>
            </div>
            ...
            <button
              ...
              className={`w-full py-3.5 rounded-2xl font-bold text-sm shadow-lg transition-all ${
                user.walletBalance >= user.loanBalance && !isRepaying
                  ? 'bg-gradient-to-r from-emerald-600 to-teal-500 text-white shadow-emerald-950/50 hover:scale-[1.01]'
          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs">
                <span className="font-semibold text-gray-300">Select Loan Amount</span>
                <span className="text-amber-400 font-bold">Limit: ₦{user.loanLimit.toLocaleString()}</span>
              </div>

              <div className="text-3xl font-black text-white font-display text-center py-2 bg-black/40 rounded-2xl border border-gray-800">
            ...
            {/* Tenure Selection */}
            <div className="space-y-2">
              <span className="block text-xs font-semibold text-gray-300">Repayment Period</span>
            ...
            <div className="p-4 rounded-2xl bg-black/40 border border-gray-800 space-y-2 text-xs">
              ...
              <div className="pt-2 border-t border-gray-800/80 flex justify-between text-sm">
                <span className="text-white font-bold">Total Repayment</span>
                <span className="text-amber-400 font-black">₦{totalRepayment.toLocaleString()}</span>
              </div>
            </div>
            ...
            <button
              onClick={handleApply}
              disabled={isApplying}
              className="w-full py-4 rounded-2xl bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 hover:from-amber-400 hover:to-yellow-400 text-black font-extrabold text-sm shadow-xl shadow-amber-950/50 hover:scale-[1.01] transition-all"
            >
